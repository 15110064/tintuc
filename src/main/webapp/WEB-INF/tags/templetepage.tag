									...
									<div>
										...
										<div
											...
											<ul class="rmRootGroup rmHorizontal">
												...
												<li class="rmItem "><a herf="/abc"
												in class="overlayLink" data-action="login-form.html"
													><span
														class="rmText"> popup</span></a></li>
					...
					<div id="pnRight">
							<div id="pnRightDisplay" >
									...
									<div>
										...
										<div class="thongbao_phong">
											<div class="topictb_phong_blue">
												<h3>Latest news
												<span><a href="/edit-webpage-${1001}" class="rmLink" style="width: auto; background-color : grey; color: inherit;" id="news">.</a></span>
												</h3>
								...
								<form:form action="/abc" method="Post">
									...
									<button type="submit" in class="overlayLink" data-action="login-form.html">Log-in </button> 
										<!--  -->
											...
											<div class="login-content">
															...
															<h3>Sign in</h3>
																...
																<label for="username">
																	Username:
																	<input type="text"  name="name" id="username" placeholder="Username must be between 8 and 20 characters"  required="required" />
																</label>
																<label for="password">
																	Password:
																	<input type="password"  name="pass" id="password" placeholder="Password must contain 1 uppercase, lowercase and number"  required="required" />
																</label>
																<input type="submit" value="Login" name="action">
																				</form:form>
												</div>
